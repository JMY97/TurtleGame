...
# welcome page
game_start=input("""\n\nWelcome to My First Game [Edit by JY]\n\n_/﹋\_
(҂`_´)
<,︻╦╤─ ҉ - -      Press a to begin
_/﹋\_\n\n \n""")

#Display in case of wrong entry
if game_start.lower() != "a":
                print("Wrong input")
#Level Selection              
if game_start.lower() == "a":
                
	which_level = int(input("Which level do you want to play?(1-6) = "))
	if which_level == 1:
		max_enemy = 5
		live = 20
